 ...
 */
class Iifire_Tags_Model_Mysql4_Catalog_Product extends Mage_Core_Model_Mysql4_Abstract {
...
//        $useLongest = ($productCanonicalUrl==1) ? true : false;
        ...
        if ($canonicalAttr) {            
            $this->_select->columns(array('url' => new Zend_Db_Expr("IFNULL((SELECT canonical_url_rewrite.`request_path`
                ...
                WHERE canonical_path.`entity_id` = e.`entity_id` AND canonical_path.`attribute_id` = ".$canonicalAttr->getAttributeId().
