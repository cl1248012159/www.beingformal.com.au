...
CREATE TABLE {$this->getTable('iifire_tags_category')} (
  ...
  CONSTRAINT `FK_IIFIRE_TAGS_CATEGORY_STORE` FOREIGN KEY (`store_id`) REFERENCES {$this->getTable('core_store')} (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE {$this->getTable('iifire_tags')} (
  ...
  PRIMARY KEY (`tags_id`),
  CONSTRAINT `FK_IIFIRE_TAGS_CATEGORY_ID` FOREIGN KEY(`category_id`) REFERENCES {$this->getTable('iifire_tags_category')}(`category_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `FK_IIFIRE_TAGS_TORE` FOREIGN KEY (`store_id`) REFERENCES {$this->getTable('core_store')} (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE {$this->getTable('iifire_tags_description')} (
  ...
  CONSTRAINT `FK_IIFIRE_TAGS_DESCRIPTION_CATEGORY_ID` FOREIGN KEY(`category_id`) REFERENCES {$this->getTable('iifire_tags_category')}(`category_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `FK_IIFIRE_TAGS_DESCRIPTION` FOREIGN KEY (`store_id`) REFERENCES {$this->getTable('core_store')}(`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
