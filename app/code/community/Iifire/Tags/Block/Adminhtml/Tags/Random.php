 ...
 * @version 1.6.0
 */
class Iifire_Tags_Block_Adminhtml_Tags_Random extends Mage_Adminhtml_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('iifire/tags/random.phtml');
    }
       ...
       $this->setChild('save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'tagsControl.save(\''.$this->getUrl('*/*/saveRandom', array('continue'=>false)).'\');',
                    'class'   => 'save'
                ))
        );
        ...
        $this->setChild('save_continue_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'tagsControl.save(\''.$this->getUrl('*/*/saveRandom', array('continue'=>true)).'\');',
                    'class'     => 'save',
                ))
        );
    ...
    {
        return Mage::helper('itags')->__('Add Important Tags');
    }
}
