 ...
 * @version 1.6.0
 */
class Iifire_Tags_Block_Adminhtml_Tags_Tags_New1 extends Mage_Adminhtml_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('iifire/tags/tags/new1.phtml');
    }
    	...
    	$this->setChild('back_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick' => 'setLocation(\''.$this->getUrl('*/*/index1').'\')',
                    'class'   => 'back'
                ))
        );
       $this->setChild('save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'tagsControl.save(\''.$this->getUrl('*/*/save1', array('continue'=>false)).'\');',
                    'class'   => 'save'
                ))
        );
        ...
        $this->setChild('save_continue_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'tagsControl.save(\''.$this->getUrl('*/*/save1', array('continue'=>true)).'\');',
                    'class'     => 'save',
                ))
        );
    ...
    public function getForm()
    {
    	return $this->getLayout()
            ->createBlock('iifire_tags/adminhtml_tags_tags_new_form')
            ->toHtml();
    }
    ...
    {
        return Mage::helper('itags')->__('New Tags');
    }
}
