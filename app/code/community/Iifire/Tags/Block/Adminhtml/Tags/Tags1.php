 ...
 * @version 1.6.0
 */
class Iifire_Tags_Block_Adminhtml_Tags_Tags1 extends Mage_Adminhtml_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('iifire/tags/index1.phtml');
    }
    protected function _prepareLayout()
    {
    	$this->setChild('new_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'   => Mage::helper('itags')->__('Sensitive New'),
                    'onclick' => 'setLocation(\''.$this->getUrl('*/*/add1').'\')',
                    'class'   => 'add'
                ))
        );
        ...
        $this->setChild('grid', $this->getLayout()->createBlock('iifire_tags/adminhtml_tags_tags_grid1', 'tags.grid'));
